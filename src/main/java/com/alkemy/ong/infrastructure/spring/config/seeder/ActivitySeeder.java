...
public class ActivitySeeder {
  ...
  private static final List<String> ACTIVITIES_NAMES = List.of(
      "Apoyo Escolar para el nivel Primario", "Apoyo Escolar Nivel Secundaria", "Tutorías");
  private static final List<String> ACTIVITIES_CONTENTS = List.of("El espacio de apoyo escolar es "
      + "el corazón del área educativa. Se realizan los "
      ...
      + "escuela.", "Del mismo modo que en primaria, este taller es el corazón del área "
      ...
      + "relación entre ellos y la institución.", "Es un programa destinado a jóvenes a "
      + "partir del tercer año de secundaria, "
      ...
      + "correspondan.");
  private static final String ACTIVITY_IMAGE = "url/de/la/imagen";
  ...
  private void createActivity() {
    if (activityRepository.count() < 3) {
      saveActivities(ACTIVITIES_NAMES, ACTIVITIES_CONTENTS);
    }
  }

  private void saveActivities(List<String> names, List<String> contents) {
